...
SimpleForm.setup do |config|
  config.error_notification_class = 'alert alert-danger col-md-9'
  ...
  config.wrappers :horizontal_form, tag: 'div', class: 'form-group row justify-content-center', error_class: 'has-danger' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
